...
# 三个非鱼的"奇遇"事件，把上面的东西钓上来
EVENTS.update(json.loads(r"""{"lone_sock_drift": {"id": "lone_sock_drift", "name": "漂来的袜子", "type": "treasure", "weight": 12, "description": "水面上慢悠悠漂来一团湿乎乎的东西，你满怀期待地一把捞起——", "rewards": {"items": [{"id": "lone_sock", "qty": 1}]}}, "old_bookmark_drift": {"id": "old_bookmark_drift", "name": "漂来的旧书", "type": "treasure", "weight": 9, "description": "一本鼓胀的旧书随波浮来，书页早糊成一块，只有一枚书签还固执地夹在里面。", "rewards": {"items": [{"id": "old_bookmark", "qty": 1}]}}, "unfinished_chapter_drift": {"id": "unfinished_chapter_drift", "name": "浮起的稿纸", "type": "treasure", "weight": 4, "description": "一卷被水泡得发胀的稿纸从水底缓缓浮起，红笔的批注在水里晕开成一片片云。", "rewards": {"items": [{"id": "unfinished_chapter", "qty": 1}]}}}"""))
